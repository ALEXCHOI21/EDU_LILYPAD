...
에이전트는 원단 소싱, 시장 조사, 스케쥴 관리 등 디자인 외의 복잡한 업무를 스스로 처리하여 여러분이 '창의성'에만 집중할 수 있게 돕습니다.
      ...
      { 
        ...
        description: "구글의 AI 실험실 도구를 통해 내가 대충 그린 스케치를 인공지능이 어떻게 완벽한 아이콘으로 바꿔주는지 경험해 봅니다.",
        links: [
          {
            title: "AutoDraw",
            url: "https://www.autodraw.com/",
            summary: "AI가 내 낙서를 정교한 일러스트로 변신시켜주는 인공지능 드로잉 도구입니다."
          },
          {
            title: "Quick Draw",
            url: "https://quickdraw.withgoogle.com/",
            summary: "내가 그리는 그림을 AI가 실시간으로 알아맞히며 기계학습의 데이터를 쌓는 재미있는 게임입니다."
          }
        ],
        theory: `
### 🎨 내 낙서가 전문 일러스트로!
구글의 **AutoDraw**는 여러분이 마우스로 대충 그린 그림을 보고 AI가 "혹시 이런 걸 그리려 했나요?"라며 정교한 결과물을 추천해 줍니다. 인공지능의 시각 인식 능력을 가장 쉽고 재미있게 체험할 수 있는 도구입니다.
        `,
  ...
  },
  {
    ...
    items: [
      { 
        id: 5, 
        title: "블럭코딩의 역사와 미래", 
        youtubeId: "X605S-u-6mE",
        description: "코딩은 영어가 아니라 '논리'입니다. 블럭을 쌓듯이 생각을 조립하는 블럭코딩의 원리를 배웁니다.",
        tags: ["Logic", "Visual Coding"]
      },
      { 
        id: 6, 
