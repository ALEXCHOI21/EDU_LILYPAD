...
방대한 소재 아카이브나 브랜드 컨셉북을 NotebookLM에 학습시키면, 언제든 필요할 때 정보를 바로 꺼내 쓸 수 있는 초강력 비서가 됩니다.
      ...
      { 
        ...
        links: [
          {
            title: "Antigravity 공식 사이트",
            url: "https://antigravity.google/",
            summary: "구글 딥마인드 'Advanced Agentic Coding' 팀이 개발하는 초격차 AI 시스템 오케스트레이터 정보를 확인하세요."
          }
        ],
        theory: `
...
4. **시각적 아름다움**: 회로 자체가 하나의 자수 디자인이 됩니다. 기술을 숨기는 것이 아니라, 디자인의 일부로 승화시킬 수 있는 유일한 하드웨어입니다.
  ...
  {
    day: 5,
    title: "Archive (교육 자료실)",
    description: "공통 교육 자료 및 실습에 필요한 참고 텍스트를 이곳에서 다운로드할 수 있습니다.",
    items: [
      { 
        id: "archive-1", 
        title: "2026 인문·예술 트렌드 분석자료", 
        youtubeId: null,
        description: "패션 디자인과 AI의 결합에 영감을 주는 2026년 인문·예술 비즈니스 트렌드 요약본입니다.",
        links: [
          {
            title: "트렌드 자료 다운로드 (.txt)",
            url: "resources/1. 2026 인문·예술 트렌드.txt",
            summary: "2026년 패션 아키텍트를 위한 인문학적 인사이트가 담긴 자료입니다."
          }
        ],
        theory: `
### 🎓 자료 활용 가이드
이 자료는 단순히 읽는 것에 그치지 않고, **Gemini**나 **NotebookLM**에 학습시켜 여러분만의 고유한 디자인 컨셉을 도출하는 데 최적화되어 있습니다.

### 💡 학습 팁
1. 텍스트 파일을 다운로드합니다.
2. NotebookLM의 소스(Source)로 추가합니다.
3. "이 트렌드 내용을 바탕으로 릴리패드 점퍼의 LED 패턴을 제안해줘"라고 질문해 보세요.
        `,
        tags: ["Resource", "Trend 2026"]
      }
    ]
  }
];
