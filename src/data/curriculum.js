  ...
  },
  {
    ...
    items: [
      { 
        ...
        description: "디자이너와 예술가들을 위해 만들어진 작고 강력한 컴퓨터, 아두이노의 탄생 비화와 철학을 만납니다.",
        theory: `
### 🇮🇹 이탈리아에서 온 디자이너의 도구
아두이노는 공학자가 아닌, **예술가와 디자이너**들이 기술을 쉽게 배우고 작품에 활용할 수 있도록 이탈리아 이브레아 디자인 학교에서 시작되었습니다.

### 🌟 왜 아두이노인가요?
- **오픈 소스**: 누구나 설계를 보고 응용할 수 있는 열린 기술입니다.
- **예술적 접근**: 복잡한 전자공학 지식이 없어도 상상을 현실로 바꿀 수 있는 '도구'로서 기획되었습니다.
- **릴리패드(LilyPad)**: 아두이노의 철학을 이어받아, 패션 디자이너들이 옷에 꿰매어 사용할 수 있도록 탄생한 웨어러블 전용 보드입니다.
        `,
        tags: ["Hardware", "Designer Tech", "Arduino"]
      },
      { 
        id: 9, 
