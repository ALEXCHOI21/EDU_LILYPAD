...
방대한 소재 아카이브나 브랜드 컨셉북을 NotebookLM에 학습시키면, 언제든 필요할 때 정보를 바로 꺼내 쓸 수 있는 초강력 비서가 됩니다.
      ...
      { 
        ...
        links: [
          {
            title: "Antigravity 공식 정보",
            url: "https://antigravity.ai/",
            summary: "AI 비즈니스 자동화 및 시스템 구축 전문 아키텍처 정보를 확인하세요."
          }
        ],
        theory: `
